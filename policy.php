...
<html lang="ru">
  <head>
    ...
    <title>Политика конфиденциальности - Aliance</title>
  </head>
  <body>
    ...
    <!-- /.navbar -->
     <header class="header-page">
      <div class="container">
        ...
        <h1 class="header-page-title">Политика конфиденциальности</h1>
        <ul class="breadcrumbs">
          <li class="breadcrumbs-item">
            <a href="/" class="breadcrumbs-item-link">Главная</a>
          </li>
          <li class="breadcrumbs-item active">
            <a href="contract-product.php" class="breadcrumbs-item-link">Политика конфиденциальности</a>
          </li>
        </ul>
      </div>
     </header>
