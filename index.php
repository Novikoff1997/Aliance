...
<html lang="ru">
  ...
  <body class="front-page">
    ...
    <header class="header header-image">
      <div class="container">
        <div class="header-content">
          ...
          <button class="header-button button">Подробнее о компании</button>
        </div>
        <!-- /.header-content -->
    ...
    <section class="section section-light section-light-main">
      <div class="container">
    ...
    <!-- /.section-products -->
    <section class="section trademarks trademarks-main">
      <div class="container">
        <div class="seporator"></div>
          ...
          <div class="clients-logo-list">
            <a href="#" class="clients-logo-item">
              <picture>
                ...
                <img src="./img/client-img/client-img.jpg" width="70" height="70" class="client-logo" alt="client-img">
              </picture>  
            </a>
            <a href="#" class="clients-logo-item">
              <picture>
      ...
      <div class="container">
        <div class="footer-wrapper">
          <div class="footer-legal">
            <p class="footer-copyright">&copy; <?= date('Y') ?> «Aliance Production». Все права защищены.</p>
